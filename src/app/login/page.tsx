      ...
      <div className={styles.loginBox}>
        ...
        <div className={styles.form}>
          <p style={{
            ...
            {isLocalTemplatePreview ? '当前是本地模板预览模式。' : '使用您的 Google 账号登录'}
          </p>
          ...
          <div style={{
            ...
            {isLocalTemplatePreview ? (
              ...
              >
                本地只用于预览后台界面，不走真实 Turnstile 或 Google 登录。
                请直接进入
                {' '}
                <Link href="/admin/dashboard" style={{ color: '#92400e', fontWeight: 600 }}>
                  /admin/dashboard
                </Link>
                。
              </div>
          ...
          <p style={{
            ...
            {isLocalTemplatePreview ? '本地只预览后台界面；真实认证请在预发布或线上环境测试。' : '仅限授权管理员访问'}
          </p>
        </div>
      </div>
    </div>
